...
func TestCryptoStreamWithZeroLength(t *testing.T) {
	nonce := []byte{
		0x69, 0x69, 0x6e, 0xe9, 0x55, 0xb6, 0x2b, 0x73,
		0xcd, 0x62, 0xbd, 0xa8, 0x75, 0xfc, 0x73, 0xd6,
		0x82, 0x19, 0xe0, 0x03, 0x6b, 0x7a, 0x0b, 0x37}
...
func TestCryptoStreamWithInvalidNonce(t *testing.T) {
	nonce := []byte{
		0x69, 0x69, 0x6e, 0xe9, 0x55, 0xb6, 0x2b, 0x73,
		0xcd, 0x62, 0xbd, 0xa8, 0x75, 0xfc, 0x73, 0xd6,
...
func TestCryptoStreamWithInvalidKey(t *testing.T) {
	nonce := []byte{
		0x69, 0x69, 0x6e, 0xe9, 0x55, 0xb6, 0x2b, 0x73,
		0xcd, 0x62, 0xbd, 0xa8, 0x75, 0xfc, 0x73, 0xd6,
		0x82, 0x19, 0xe0, 0x03, 0x6b, 0x7a, 0x0b, 0x37}
...
func TestCryptoStreamXorWithZeroLengthMessage(t *testing.T) {
	message := []byte{}
...
func TestCryptoStreamXorWithInvalidNonce(t *testing.T) {
	message := []byte{
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
func TestCryptoStreamXorWithInvalidKey(t *testing.T) {
	message := []byte{
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
func TestCryptoStreamSalsa20WithZeroLength(t *testing.T) {
	nonce := []byte{
		0x82, 0x19, 0xe0, 0x03, 0x6b, 0x7a, 0x0b, 0x37}
...
func TestCryptoStreamSalsa20WithInvalidNonce(t *testing.T) {
	nonce := []byte{
		0x82, 0x19, 0xe0, 0x03, 0x6b, 0x7a, 0x0b}
...
func TestCryptoStreamSalsa20WithInvalidKey(t *testing.T) {
	nonce := []byte{
		0x82, 0x19, 0xe0, 0x03, 0x6b, 0x7a, 0x0b, 0x37}
...
func TestCryptoStreamSalsa20XorWithZeroLengthMessage(t *testing.T) {
	message := []byte{}
...
func TestCryptoStreamSalsa20XorWithInvalidNonce(t *testing.T) {
	message := []byte{
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
func TestCryptoStreamSalsa20XorWithInvalidKey(t *testing.T) {
	message := []byte{
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
